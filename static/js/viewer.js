...
(function (global, factory) {
    ...
    var render = {
        ...
        renderList: function renderList() {
            ...
            var gutter = parseInt(
                window.getComputedStyle(next || item).marginLeft,
                10
            );
            ...
            setStyle(
                ...
                assign(
                    ...
                    getTransforms({
                        translateX:
                            (this.viewerData.width - offsetWidth) / 2 -
                            outerWidth * index,
                    })
                )
            );
        ...
        initImage: function initImage(done) {
            ...
            sizingImage = getImageNaturalSizes(
                ...
                function (naturalWidth, naturalHeight) {
                    ...
                    var initialCoverage = Math.max(
                        0,
                        Math.min(1, options.initialCoverage)
                    );
                    ...
                    initialCoverage = isNumber(initialCoverage)
                        ? initialCoverage
                        : 0.9;
    ...
    var methods = {
        ...
        hide: function hide() {
            ...
            if (options.transition && !immediate) {
                var onViewerTransitionEnd = function onViewerTransitionEnd(
                    event
                ) {
        ...
        update: function update() {
            ...
            if (this.ready) {
                ...
                if (this.isShown) {
                    if (this.length) {
                        if (this.viewed) {
                            var changedIndex = changedIndexes.indexOf(
                                this.index
                            );
                            if (changedIndex >= 0) {
                                this.viewed = false;
        ...
        change: function change(event) {
            ...
            switch (this.action) {
                ...
                case ACTION_SWITCH: {
                    ...
                    if (
                        absoluteOffsetX > 1 &&
                        absoluteOffsetX > Math.abs(offsetY)
                    ) {
                ...
                [
                    {
                        ...
                        value: function init() {
                            ...
                            if (
                                isUndefined(
                                    document.createElement(NAMESPACE).style
                                        .transition
                                )
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function build() {
                            ...
                            var title = viewer.querySelector(
                            ...
                            this.list = viewer.querySelector(
                                ".".concat(NAMESPACE, "-list")
                            );
                            ...
                            if (options.toolbar) {
                                ...
                                if (!custom) {
                                    addClass(
                                        toolbar,
                                        getResponsiveClass(options.toolbar)
                                    );
                                }
                                forEach(
                                    ...
                                    function (value, index) {
                                        var deep =
                                            custom && isPlainObject(value);
                                        var name = custom
                                            ? hyphenate(index)
                                            : value;
                                        var show =
                                            deep && !isUndefined(value.show)
                                                ? value.show
                                                : value;
                                        if (
                                            !show ||
                                            (!options.zoomable &&
                                                zoomButtons.indexOf(name) !==
                                                    -1) ||
                                            (!options.rotatable &&
                                                rotateButtons.indexOf(name) !==
                                                    -1) ||
                                            (!options.scalable &&
                                                scaleButtons.indexOf(name) !==
                                                    -1)
                                        ) {
                                            return;
                                        }
                                        var size =
                                            deep && !isUndefined(value.size)
                                                ? value.size
                                                : value;
                                        var click =
                                            deep && !isUndefined(value.click)
                                                ? value.click
                                                : value;
                                        var item = document.createElement("li");
                                        if (options.keyboard) {
                                        ...
                                        if (isNumber(show)) {
                                            addClass(
                                                item,
                                                getResponsiveClass(show)
                                            );
                                        }
                                        if (
                                            ["small", "large"].indexOf(size) !==
                                            -1
                                        ) {
                                            addClass(
                                                item,
                            ...
                            if (!options.rotatable) {
                                var rotates = toolbar.querySelectorAll(
                                    'li[class*="rotate"]'
                                );
